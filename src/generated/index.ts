...
export type PageQuery = {
  __typename?: 'Query'
  page?: { __typename?: 'Page'; content: string; createdAt: any } | null
}
...
export function useHobbiesQuery(
  options?: Omit<Urql.UseQueryArgs<HobbiesQueryVariables>, 'query'>,
) {
  return Urql.useQuery<HobbiesQuery, HobbiesQueryVariables>({
    query: HobbiesDocument,
    ...options,
  })
}
...
export function useProjectsSlugsQuery(
  options?: Omit<Urql.UseQueryArgs<ProjectsSlugsQueryVariables>, 'query'>,
) {
  return Urql.useQuery<ProjectsSlugsQuery, ProjectsSlugsQueryVariables>({
