...
const Scene: FC = () => {
  ...
  useFrame(() => {
    if (!isPhone) {
      ...
      saturn.rotation.y = date * 2
      asteroidsOne.rotation.y = date * 2
      asteroidsTwo.rotation.y = date * 2
    }
  })

  saturn.rotation.x = degToRad(20)
  asteroidsOne.rotation.x = degToRad(20)
  asteroidsTwo.rotation.x = degToRad(20)
    ...
    <Selection>
      ...
      <scene>
        ...
        <Suspense fallback={<></>}>
          ...
          <pointLight position={[0, 0, -50]} intensity={400} color="#fff" />
          <pointLight position={[0, 0, -10]} intensity={400} color="#fff" />
          ...
          <motion.primitive
            ...
            initial={{ rotateY: Math.PI / 7, y: 3, rotateX: 0 }}
