...
const ProjectCard: FC<Props> = ({ projectData }) => {
  const { mainImage, name, description, techs, typeOfApp } = projectData

  return (
    <div className="flex flex-col backdrop-blur bg-brandWhite bg-opacity-10 rounded-lg px-4 pt-4 pb-8">
      ...
      <div className="flex justify-between mt-6">
        <h3 className="text-2xl font-semibold text-white font-montserrat">{name}</h3>
        <Badge
